...
**vision/py/main_eyes.py** uses textures from this folder for the animated eyes (sclera + iris + pupil). Any size is resized to 240×240.
...
Then run **vision/py/main_eyes.py** as usual.
