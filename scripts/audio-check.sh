...
echo "5. From repo root, WAV test: aplay -D plughw:0,0 sounds/assets/giggle.wav"
echo "6. If sound works after reboot but stops after wake-furbacca: try FURBACCA_SKIP_AMIXER=1; if no help, try wake-furbacca --no-eye-track (see README)."
